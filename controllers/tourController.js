...
const multerFilter = (_req, file, cb) => {
  if (file.mimetype.startsWith('image')) {
    ...
    cb(new AppError('Gönderdiğin resim değil amını dağıttığım', 400), false);
  }
};
...
exports.getTour = factory.getOne(Tour, /* 'reviews' */ { path: 'reviews' });
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    next(new AppError('Enlem ve boylam bilgisini düzgün gir lan orospu'));
  }
