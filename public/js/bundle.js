...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYml0aWtwaWwiLCJhIjoiY2t6cTRjNWFxMHM2aDJycGVsZmZvdXJpbiJ9.Ycc6kwEu8XMc5hPGT9AJrg';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Girdin lan yaprağım hadi iyisin');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Çıkamadın lan sonra dene');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', type === 'password' ? 'Şifre güncelleme başarılı' : 'Veri güncelleme başarılı');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51KWhXLEJ7rY53jT9sV2BKbu214NwE79BPmBG3AC8DUt4aKKzNeyjeHclS7yUllyrJXPSwbfbJrwgemYfjIhAXjwS00xEO28fzl');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Ödeme alınıyor...';
